      ...
      >
       <div className="w-[500px] h-[500px] flex flex-col justify-evenly bg-gray-200 p-4 rounded-2xl">
          ...
          <div className="flex justify-center mb-1">
            <div className="">
              <a
                className="bg-[#016565] hover:bg-orange-800 text-white font-bold py-2 px-4 rounded mb-2 mx-2"
                target="_blank"
              ...
              <a
                className="bg-[#016565] hover:bg-orange-800 text-white font-bold py-2 px-4 rounded"
                target="_blank"
